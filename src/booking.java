...
public class booking extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter PAN card or Aadhar Card Number for booking");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Aadhar Number", "PAN number" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        hotels_search obj1=new hotels_search();
        Hotel1 obj2=new Hotel1();
        obj2=obj1.takeobj();
